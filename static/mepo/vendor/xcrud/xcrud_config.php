...
{
    // default connection
    public static $dbname = 'mkDienstedb08'; // Your database name
    public static $dbuser = 'mkdienste'; // Your database username
    public static $dbpass = 'mkDiensteDB'; // // Your database password
    public static $dbhost = '127.0.0.1:3307'; // Your database host, 'localhost' is default.
